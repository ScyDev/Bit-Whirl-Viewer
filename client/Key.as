...
package {
    ...
    public class Key {
         ...
         */
        public static function initialize(watchedElement) {
            if (!initialized) {
                initialized = true;
            }
                // assign listeners for key presses and deactivation of the player
                watchedElement.addEventListener(KeyboardEvent.KEY_DOWN, keyPressed);
                watchedElement.addEventListener(KeyboardEvent.KEY_UP, keyReleased);
                watchedElement.addEventListener(Event.DEACTIVATE, clearKeys);
