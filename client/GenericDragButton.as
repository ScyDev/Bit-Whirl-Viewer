...
package
{
	...
	[Event(name="dragUpdate",type="DragEvent")]
	 ...
	 * @author Josh Tynjala
	 */
	public class GenericDragButton extends Button
	{
	...
	//--------------------------------------
		 ...
		 * Constructor.
		 */
		public function GenericDragButton()
		{
			super();
	...
	//--------------------------------------
		...
		public function setIcon(value:String, width, height)
		{
